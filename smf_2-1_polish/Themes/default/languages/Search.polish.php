...
$txt['spider_mode_vhigh'] = 'Bardzo wysoki';
...
$txt['spider_group_note'] = 'Aby włączyć indeksowanie przez roboty niektórych stron.';
...
$txt['add_spider_desc'] = 'Z tej strony możesz edytować parametry, według których roboty są klasyfikowane. Jeśli użytkownik/adres IP użytkownika pasuje do tych wpisanych poniżej, zostanie wykryty jako robot i zacznie być śledzony.';
...
$txt['spider_log_empty_log'] = 'Wyczyść log';
$txt['spider_log_empty_log_confirm'] = 'Jesteś pewny, że chcesz kompletnie wyczyścić log';
...
$txt['spider_stats_delete_older'] = 'Usuń statystyki wszystkich pająków nie widzianych od %1$s dni. ';

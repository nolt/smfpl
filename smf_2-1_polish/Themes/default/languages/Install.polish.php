...
$txt['db_settings_type_info'] = 'Wykryto możliwość korzystania z różnych typów baz danych - który typ chcesz użyć? Pamiętaj że od wersji SMF 2.0 RC3 działanie kilku instalacji SMF jednej bazie PostgreSQL nie jest obsługiwane, w związku z tym musisz zaktualizować swoją instalację SMF.';
...
$txt['user_settings_server_email_info'] = 'Podaj <strong>adres, którego SMF używać będzie do wysyłania maili</strong>. Adres ten musi być prawidłowy!';

...
$txt['agree_coppa_above'] = 'Posiadam co najmniej %1$d lat.';
$txt['agree_coppa_below'] = 'Jestem młodszy niż %1$d lat. ';
...
$txt['login_below_or_register'] = 'Zaloguj się lub <a href="%1$s">zarejestruj nowe konto</a> poprzez %2$s';
...
$txt['activate_after_registration'] = 'Dziękujemy za rejestrację. Wkrótce otrzymasz email z odnośnikiem potrzebnym do aktywacji konta, sprawdź także folder Spam.';
...
$txt['in_maintain_mode'] = 'Forum działa w trybie obsługi.';

// These two are used as a javascript alert; please use international characters directly, not as entities.
$txt['register_agree'] = 'Prosimy o przeczytanie i zaakceptowanie warunków przed rejestracją konta.';

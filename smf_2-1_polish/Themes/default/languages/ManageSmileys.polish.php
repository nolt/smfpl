...
$txt['smiley_sets_confirm'] = 'Czy na pewno chcesz usunąć ten zestaw emotikon?-n-Uwaga: pliki nie zostaną usunięte, tylko nie będą mogły być wybrane.';
$txt['smiley_sets_none'] = 'Nie wybrano obecnie żadnego zestawu emotikon.';
...
$txt['setting_smileys_dir_wrong'] = 'Ścieżka do emotikon jest nieprawidłowa. Spowoduje to, że emotikony nie będą działały poprawnie';
...
$txt['smiley_set_import_single'] = 'W tym zestawie znajduje się jeszcze nie zaimportowana emotikona. Kliknij <a href="%1$s">tutaj</a> aby ją importować.';
$txt['smiley_set_import_multiple'] = 'Jest %1$d emotikon w katalogu, które nie zostały jeszcze zaimportowane. Kliknij <a href="%2$s">tutaj</a> aby importować je teraz.';
...
$txt['smileys_location_popup'] = 'Więcej';
...
$txt['smileys_location_popup_description'] = 'Te emotikony pojawią się w wyskakującym okienku, wywoływanym poprzez kliknięcie przycisku \'więcej\'.';
...
$txt['icons_filename_all_png'] = 'Wszystkie pliki muszą mieć rozszerzenie &quot;png&quot;';

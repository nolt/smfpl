...
$txt['permissionhelp_profile_view'] = 'Po kliknięciu na nazwę danego użytkownika, umożliwia dostęp do podsumowania ustawień profilu oraz kilku statystyk i wszystkich wysłanych wiadomości.';
...
$txt['permissionname_likes_view'] = '';
$txt['permissionname_likes_like'] = 'Can like any content';
$txt['permissionhelp_likes_view'] = '';
...
$txt['permissions_post_moderation_desc'] = 'Na tej stronie możesz skonfigurować możliwość zatrzymania wyświetlenia wiadomości dla normalnych użytkowników przed ich zatwierdzeniem. Autor wiadomości widzi ją nawet jeśli nie została zatwierdzona, dotyczy to także odpowiedzi na własne wiadomości, ale także komentarzy dodanych przez moderatorów do tej wiadomości.';

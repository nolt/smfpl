...
$txt['membergroups_can_manage_access'] = 'Grupa ta widzi wszystkie działy gdyż ma zezwolenie zarządzania działami.';

$txt['membergroups_cannot_delete_paid'] = 'Ta grupa nie może zostać usunięta, jest obecnie używana przez znastępujących płatnych subskrybentów: %1$s';
...
$txt['membergroups_edit_hidden_warning'] = 'Czy jesteś pewien, że chcesz zabronić przypisania użytkowników do tej grupy jako grupy podstawowej?\\n\\nUstawienie tego wymusi przydzielanie tylko jako grupę dodatkową oraz zaktualizuje użytkownikom tę &quot;podstawową&quot; grupę na dodatkową. Spowoduje to także usunięcie z grupy moderatorów którzy są przypisani do konkretnych działów.';
...
$txt['membergroups_icon_count'] = 'Liczba obrazów ikony';
$txt['membergroups_icon_image'] = 'Nazwa pliku ikony';
$txt['membergroups_icon_image_note'] = 'Możesz wysłać własne obrazki do katalogu z domyślnym stylem, a następnie je wybrać. Różne obrazki mogą być używane w różnych stylach, po prostu nadaj im tę samą nazwę.';
...
$txt['membergroups_tfa_force'] = 'Wymuś uwierzytelnianie wielopoziomowe (2FA) dla tej grupy użytkowników';
$txt['membergroups_tfa_force_note'] = 'Uprzedź użytkowników przed włączeniem tej opcji!';
...
$txt['membergroups_confirm_delete_mod'] = 'Grupa jest przydzielona do moderowania jednego lub więcej działów. Czy aby na pewno chcesz ją usunąć?';
$txt['membergroups_swap_mod'] = 'Grupa ta jest przypisana do moderowania jednego lub więcej działów. Zmiana na grupę opartą o liczbę wiadomości spowoduje usunięcie z grupy moderatorów.';

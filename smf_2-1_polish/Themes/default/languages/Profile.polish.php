...
$txt['popup_summary'] = 'Mój profil';
$txt['popup_showposts'] = 'Moje wiadomości';
...
$txt['preview_signature'] = 'Podgląd sygnatury';
$txt['current_signature'] = 'Obecna sygnatura';
$txt['signature_preview'] = 'Podgląd sygnatury';
...
$txt['skype_username'] = 'Nazwa użytkownika Skype';
...
$txt['password_success'] = 'Twoje hasło zostało pomyślnie zmienione. <br>Kliknij <a href="' . $scripturl . '?action=login">tutaj</a> aby się zalogować.';
...
$txt['watched_boards'] = 'Obserwowane dzialy';
...
$txt['notification_general'] = 'Ustawienia ogólne';
...
$txt['notify_send_type_everything_own'] = 'Moderacji, jeśli to ja rozpocząłem wątek i go obserwuję';
...
$txt['notify_what_how'] = 'Ustawienia powiadomień';
$txt['receive_alert'] = 'Wyślij powiadomienie';
$txt['receive_mail'] = 'Wyślij email';
$txt['alert_group_board'] = 'Boards and Topics';
$txt['alert_group_msg'] = 'Wiadomości';
...
$txt['alert_group_pm'] = 'Prywatne wiadomości';
...
$txt['alert_group_moderation'] = 'Moderacja';
...
$txt['alert_group_members'] = 'Użytkownicy';
...
$txt['alert_group_calendar'] = 'Kalendarz';
...
$txt['deleteAccount_all_posts'] = 'Odpowiedzi w wątkach';
...
$txt['showUnwatched'] = 'Nieobserwowane wątki';
$txt['showAttachments'] = 'Pokaż załączniki';
$txt['viewWarning_help'] = 'Ta sekcja pozwala Ci na wyświetlenie wszystkich ostrzeżeń przyznanych temu użytkownikowi.';
...
$txt['ignoreboards'] = 'Ignoruj działy';
...
$txt['trackLogins_desc'] = 'Niżej znajduje się kompletna lista logowań tego konta od momentu rejestracji.';
...
$txt['trackLogins_none_found'] = 'Nie znaleziono logowań przez użytkowników';
$txt['none'] = 'Brak';
...
$txt['registration_not_approved'] = 'Przepraszamy, to konto nie zostało jeszcze zatwierdzone. Jeśli chcesz zmienić adres email, kliknij <a href="%1$s">tutaj</a>.';
$txt['registration_not_activated'] = 'Przepraszamy, to konto nie zostało jeszcze aktywowane. Jeśli chcesz ponownie otrzymać email aktywacyjny, kliknij <a href="%1$s">here</a>';
...
$txt['use_editor_quick_reply'] = 'Pokaż pełny edytor w szybkiej odpowiedzi';
$txt['display_quick_mod'] = 'Pokaż szybką moderację jako ';
...
$txt['unwatched_topics_none'] = 'Nie masz żadnych wątków na liście nieobserwowanych.';
...
$txt['regular_members_desc'] = 'Każdy użytkownik forum nie posiadający odznaki lub tytułu należy do tej grupy.';

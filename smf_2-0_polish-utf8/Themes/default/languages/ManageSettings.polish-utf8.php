...
$txt['image_proxy_enabled'] = 'Włącz proxy obrazków';
$txt['image_proxy_enabled_desc'] = 'Umożliwia korzystanie z proxy dla obrazków umieszczanych w tagach <b>[img]</b>.';
$txt['image_proxy_secret'] = 'Sekretny kod proxy';
$txt['image_proxy_secret_desc'] = 'Kod powinien być unikalny dla Twojej strony. Nie udostępniaj go nikomu.';
$txt['image_proxy_maxsize'] = 'Maksymalny rozmiar pliku cache dla obrazków';
$txt['image_proxy_maxsize_postinput'] = 'KB';
$txt['image_proxy_maxsize_desc'] = 'Obrazki powyżej ustawionej wielkości nadal będą wyświetlane.';

...
$txt['admin_groups'] = 'Grupy użytkowników forum';
$txt['admin_members'] = 'Zobacz wszystkich użytkowników forum';
$txt['admin_members_list'] = 'Poniżej znajduje się lista wszystkich obecnie zarejestrowanych użytkowników tego forum.';
$txt['admin_next'] = 'Następna strona';
$txt['admin_censored_words'] = 'Modyfikuj cenzurowane słowa';
$txt['admin_censored_where'] = 'Po lewej wpisz słowo do ocenzurowania, po prawej to na co ma być zmienione.';
...
$txt['admin_modifications'] = 'Ustawienia modyfikacji forum';
...
$txt['admin_news'] = 'Włącz aktualności (pobierane z simplemachines.org)';
$txt['admin_guest_post'] = 'Włącz wysyłanie wiadomości przez niezarejestrowanych';
$txt['admin_manage_members'] = 'Użytkownicy';
$txt['admin_main'] = 'Forum Główne';
$txt['admin_config'] = 'Konfiguracja Forum';
$txt['admin_version_check'] = 'Szczegółowe sprawdzenie wersji';
$txt['admin_smffile'] = 'Plik SMF';
$txt['admin_smfpackage'] = 'Pakiet SMF';
$txt['admin_maintenance'] = 'Konserwacja forum';
$txt['admin_image_text'] = 'Pokaż przyciski jako obrazki, zamiast tekstu';
$txt['admin_credits'] = 'Twórcy skryptu';
$txt['admin_agreement'] = 'Pokaż umowę rejestracyjną przy rejestracji';
$txt['admin_agreement_default'] = 'Domyślna wersja umowy (w przypadku wielowersjowej umowy)';
...
$txt['admin_news_desc'] = 'Umieszczaj jedną wiadomość per okienko. Niektóre kody BBC, np. <span title="Pogrubienie">[b]</span>, <span title="Kursywa">[i]</span> i <span title="Podkreślenie">[u]</span> mogą być użyte w aktualnościach, podobnie jak emotikony i kod HTML. Wyczyść okienko aby usunąć daną wiadomość.';
...
$txt['admin_check_display'] = 'Sprawdź wyświetlaną nazwę użytkownika.';
...
$txt['admin_bbc'] = 'Pokaż przyciski kodów BBC w oknie wysyłania wiadomości normalnych i prywatnych';
...
$txt['errors_list'] = 'Wykaz błędów forum';
$txt['errors_found'] = 'Twoje forum aktualnie generuje następujące komunikaty błędów (pusta lista oznacza brak błędów)';

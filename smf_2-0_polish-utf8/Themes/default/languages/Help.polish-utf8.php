...
$helptxt['edit_wait_time'] = 'Liczba sekund, w których można jeszcze edytować wiadomość zanim zostanie zapisana informacja o dacie ostatniej modyfikacji.';
...
$helptxt['field_show_enclosed'] = 'Osadza w HTML lub tekście dane wprowadzone przez użytkownika. Pozwoli Ci na dodanie większej ilości protokołów (komunikatorów), obrazków itp. Dla przykładu:<br /><br />
...
$helptxt['image_proxy_enabled'] = 'Ustawienie włącza proxy obrazków';
$helptxt['image_proxy_secret'] = 'Nie udostępniaj tego kodu, służy on do ochrony przed hotlinkowaniem obrazków z Twojego forum. Zmień go, aby renderować obecne hotlinkowane obrazki.';
$helptxt['image_proxy_maxsize'] = 'Maksymalny rozmiar obrazka, który będzie cache\'owany przez proxy obrazków; obrazki większe nie będą cache\'owane. Pliki cache\'owanych obrazków przechowywane są w głównym katalogu SMF (folder cache). Upewnij się, że masz wystarczająco miejsca na swoim serwerze.';

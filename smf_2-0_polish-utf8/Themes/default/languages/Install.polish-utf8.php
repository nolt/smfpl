...
$txt['default_topic_message'] = 'Witamy na Simple Machines Forum!<br /><br />Mamy nadzieję, że używanie Twojego forum będzie Ci się podobało.&nbsp;Jeśli napotkasz jakiekolwiek problemy, zawsze możesz [url=http://www.simplemachines.org/community/index.php]zwrócić się do nas po pomoc[/url].<br /><br />Dziękujemy!<br />Simple Machines<br /><br />';
...
$txt['user_settings_username_info'] = 'Wybierz nazwę użytkownika, za pomocą której będziesz się logować.<br />Nie może być ona zmieniona później, ale możesz zmienić swoją nazwę wyświetlaną.';
...
$txt['error_windows_chmod'] = 'Jesteś na serwerze Windows i niektóre niezbędne pliki nie są zapisywalne. Poproś właściciela serwera aby umożliwił <strong>zapisywanie plików</strong> Twojej instalacji SMF użytkownikowi, u którego jest uruchomione PHP.';
